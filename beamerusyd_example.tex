...
%                           Introduction
%--------------------------------------------------------------------
% This is an example of an unofficial University of Sydney LaTeX Beamer theme for the 
...
% Please note that this template is still under development. Any comments, feedback, additions, 
...
%\usetheme{usyd}							% use eventually when doc setup is separated into .sty files
